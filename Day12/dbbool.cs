...
public struct DBBool
{
    ...
    {
        Console.WriteLine("> DBBool(bool x)");
    ...
    {
        Console.WriteLine("> bool(DBBool x)");
    ...
    {
        Console.WriteLine("> ==(DBBool x, DBBool y)");
    ...
    {
        Console.WriteLine("> true(DBBool x)");
        return x.value > 0;
    }
    ...
    {
        Console.WriteLine("> false(DBBool x)");
        return x.value < 0;
    }
    ...
    {
        Console.WriteLine("> string(DBBool x)");
...
class Test
{
    static void Main()
    {
        ...
        Console.WriteLine("{0}", a == true);
        Console.WriteLine("{0}", false == a);
